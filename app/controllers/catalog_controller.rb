...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_facet_field 'ethnicGroup_facet', label: 'Ethnic Group'
    config.add_facet_field 'militaryGroup_facet', label: 'Military Group'
    ...
    config.add_index_field 'keyword_t', label: 'Keyword'
    ...
    config.add_show_field 'otherLocation_t', label: 'Other Location'
    config.add_show_field 'place_t', label: 'Place'
    config.add_show_field 'person_t', label: 'Person'
    ...
    config.add_search_field('originalLocation') do |field|
      field.solr_parameters = {

        qf: '${originallocation_qf}',
        pf: '${originallocation_pf}'
      }
    end
    config.add_search_field('firstLocation') do |field|
      field.solr_parameters = {
    ...
    config.add_search_field('otherLocation') do |field|
      field.solr_parameters = {
    ...
    config.add_search_field('ethnicGroup') do |field|
      field.solr_parameters = {
    ...
    config.add_search_field('militaryGroup') do |field|
      field.solr_parameters = {
